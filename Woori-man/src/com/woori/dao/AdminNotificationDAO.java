...
public class AdminNotificationDAO 
{
	...
	// 공지사항 리스트 메소드
	public ArrayList<AdminDTO> noticeList() throws SQLException
	{
	...
	// CallableStatment 사용.
	//-- (제목, 내용, 작성자 번호, 파일명)
	public int addNotice(AdminDTO dto) throws SQLException
	{
		int result = 0;
	...
	public AdminDTO searchNotice(String nf_code) throws SQLException
	{
