...
$(document).ready(function()
{
	$(".findBtn").click(function()
	{
		...
		var params = "us_id="+us_id;
		 ...
		 $.ajax({
	            type: "GET"
	            , url: "findfriends.action"
	            , data: params
	            , success: function(args)
				{
	            	document.getElementById("result-info").innerHTML = args;
				}
		 		, error: function(e)
				{
...
function bookmark(cg_code, gb_code)
{
	alert(gb_code);
	
	$("#mark").css("color", "#ff8000 !important");
			  ...
			  <div class="modal-dialog modal-lg">
			    <div class="modal-content">
			      <div class="modal-header">
			        <h1 class="modal-title fs-5" id="exampleModalLabel">친구 찾기</h1>
			      ...
			      <div class="modal-body">
			        <form>
			          <div class="mb-3">
			            ...
			            <input type="text" class="form-control" id="us_id" name="us_id">
								...
								<form action="membermain.action">  
									...
									<div class="gr_name">
										...
										<div class="bookmark_zone">
											...
											<span class="book-mark" onclick="bookmark(${list.gb_code}, ${list.cg_code })">
											<i id="mark" class="bi bi-bookmark-heart-fill"></i>
											</span>
										</div>
									</div>
									</div>
